...
1. Use the position and depth AOVs to make a blurry mask near the edges.<br>Scale the blur by `1/depth` to keep it roughly the same radius in 3D.

<img src="./images/cops/edge_blend_mask.png" width="400">

2. Distort the position inside the mask using Fractal Noise 3D.<br>This keeps the noise locked in 3D space.
