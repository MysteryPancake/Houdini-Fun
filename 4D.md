...
To solve this, we can use a basic raymarching loop to minimize the distance.
...
// Basic raymarching loop, try to keep iterations low
for (int i = 0; i < 128; ++i) {
...
[Download the HIP file!](./hips/4d_snapping.hipnc?raw=true)
