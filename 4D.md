...
This scaling is required so space isn't bent out of shape. Space should be Euclidean to keep the SDF accurate.

If you use a non-uniform scale it becomes non-Euclidean, which causes rendering artifacts on [ShaderToy](https://www.shadertoy.com/).
<br>
