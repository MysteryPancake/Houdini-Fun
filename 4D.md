...
In a single change, we now have the SDF of a 4D sphere!
...
By rotating the shape in 4D, we can watch the horrors as tommy and the pig try to escape eachother.
