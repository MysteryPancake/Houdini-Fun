...
The normal tells us the direction to travel, and the SDF how far. Multiply them together and we hit the surface:
...
Generate a bunch of random points in 4D, then snap them to the 4D surface.
...
// Snap each point to nearest point on SDF
...
1. Plug a blank volume into the first input and the points into the second input:

<img src="./images/4d/4Dunion.png" width="500">

2. Write all the points into the volume as combined sphere SDFs:
...
To make it clear what's going on, I'll union the sphere the points were scattered on.
