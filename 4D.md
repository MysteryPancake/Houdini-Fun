...
Since the W axis is pretty well hidden, it's a great place to store anything you might want to hide from the general public.
<br>
...
```js
// I set W to the Z axis just in case things weren't broken enough already
