...
SDFs are pretty simple. They take a position and return the distance to the closest surface from that position.
...
<br>
Luckily it's just as simple to snap to 4D surfaces. We just need the normal and the distance.

The normal tells us the direction to travel, and the SDF how far. Combine these and we hit the nearest surface.
